...
function DiscordIcon() {
  return (
    <svg viewBox="0 0 127.14 96.36" className="h-[16px] w-[16px] flex-none fill-current" aria-hidden>
...
function TikTokIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-[14px] w-[14px] flex-none fill-current" aria-hidden>
...
function XIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-[13px] w-[13px] flex-none fill-current" aria-hidden>
...
const socials = [
  { label: "Discord", href: "https://discord.gg/letal", icon: DiscordIcon, hoverText: "hover:text-[#5865F2]" },
  { label: "TikTok", href: "https://tiktok.com/@LetalNT", icon: TikTokIcon, hoverText: "hover:text-[#FE2C55]" },
  { label: "X", href: "https://x.com/LetalNT", icon: XIcon, hoverText: "hover:text-ink" },
  { label: "YouTube", href: "https://youtube.com/@LetalNT", icon: YouTubeIcon, hoverText: "hover:text-[#FF0000]" },
];
          ...
          <div className="mt-4 flex items-center gap-2.5">
            {socials.map((social) => (
              <a
                ...
                className={`flex h-9 w-9 items-center justify-center rounded-full border-2 border-cream-border text-ink-muted transition-all duration-200 ease-bouncy hover:-translate-y-0.5 ${social.hoverText}`}
              >
                <social.icon />
              </a>
            ))}
