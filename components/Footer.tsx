...
function DiscordIcon() {
  return (
    <svg viewBox="0 0 127.14 96.36" className="h-[16px] w-[16px] flex-none fill-white" aria-hidden>
...
function TikTokIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-[14px] w-[14px] flex-none fill-white" aria-hidden>
...
function XIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-[13px] w-[13px] flex-none fill-white" aria-hidden>
...
const socials = [
  {
    ...
    hoverShadow: "hover:shadow-[0_3px_0_0_#5865F2]",
  },
  {
    label: "TikTok",
    ...
    hoverShadow: "hover:shadow-[0_3px_0_0_#FE2C55]",
  },
  {
    label: "X",
    ...
    hoverShadow: "hover:shadow-[0_3px_0_0_theme(colors.ink.DEFAULT)]",
  },
  {
    label: "YouTube",
    ...
    hoverShadow: "hover:shadow-[0_3px_0_0_#FF0000]",
  },
];
          ...
          <div className="mt-4 grid grid-cols-2 gap-2.5">
            {socials.map((social) => (
              <a
                ...
                className={`group flex items-center gap-2 rounded-xl border-2 border-cream-border bg-cream-surface py-1.5 pl-1.5 pr-3 transition-all duration-200 ease-bouncy hover:-translate-y-0.5 ${social.hoverBorder} ${social.hoverShadow}`}
              >
                <span className={`flex h-6 w-6 flex-none items-center justify-center rounded-md ${social.bg}`}>
                  <social.icon />
                </span>
                <span className="text-[13px] font-bold text-ink">{social.label}</span>
              </a>
            ))}
          </div>
        </div>
